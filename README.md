...
| --- | --- |
| **[Signal Integrity &amp; High-Speed Digital Design](https://github.com/BrendanJamesLynskey/Signal_Integrity)** | The computed companion to this material. [Timing, flight time and the budget](https://brendanjameslynskey.github.io/Signal_Integrity/15-timing-and-budgets/) covers the source-synchronous budget a parallel memory bus lives in; [Return paths](https://brendanjameslynskey.github.io/Signal_Integrity/02-return-paths/), [Crosstalk](https://brendanjameslynskey.github.io/Signal_Integrity/06-crosstalk/) and the [power-integrity section](https://brendanjameslynskey.github.io/Signal_Integrity/11-pdn-impedance/) compute the mechanisms sections 05 and 06 describe &mdash; including the [simultaneous-switching noise](https://brendanjameslynskey.github.io/Signal_Integrity/14-pi-meets-si/) that scales with the width of a parallel bus |
